...
data_path = "/n/holyscratch01/xiaoleliu_lab/cchen/sc_imputation/VAE/DNase_data/"
model_path = "/n/holyscratch01/xiaoleliu_lab/cchen/sc_imputation/VAE/model/"
...
def output():
    ...
    for type in ["BMMC_healthy","BMMC_PBMC","BMMC_CLL"]:
        expected_file_name = "/n/scratchlfs02/xiaoleliu_lab/cchen/sc_imputation/VAE/sc_specific_data/%s_filtered_specific_peaks.csv" %(type)
        input = pd.read_csv(expected_file_name,sep="\t",header=0,index_col=0)
